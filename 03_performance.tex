...
We use the Graph500 power law graph generator \cite{bader2006designing} to create random input tables,
...
in our rate measurements. % (in partial products per second).
